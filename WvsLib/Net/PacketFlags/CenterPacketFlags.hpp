...
MAKE_CENTER_SEND_PACKET_FLAG(GuildResult, 10);
MAKE_CENTER_SEND_PACKET_FLAG(FriendResult, 11);
MAKE_CENTER_SEND_PACKET_FLAG(RemoteBroadcasting, 12);
MAKE_CENTER_SEND_PACKET_FLAG(TrunkResult, 13);
MAKE_CENTER_SEND_PACKET_FLAG(EntrustedShopResult, 14);
