...
CREATE TABLE `cashitem_bundle` (
  ...
  CONSTRAINT `CS_IC` FOREIGN KEY (`CashItemSN`) REFERENCES `cashiteminfo` (`CashItemSN`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `itemlocker` (
  ...
  CONSTRAINT `CS` FOREIGN KEY (`CashItemSN`) REFERENCES `cashiteminfo` (`CashItemSN`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;
...
) ENGINE=MyISAM AUTO_INCREMENT=150758 DEFAULT CHARSET=utf8;
